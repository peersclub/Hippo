...
**In review:** [PR #21](https://github.com/peersclub/Hippo/pull/21) Partner admin portal V1 (`services/portal` :8795 + `apps/portal` :5176). Uncommitted capability WIP lives in the `wt-cap-*` worktrees (seam order-plans, intelligence capabilities, SDK render tests) — rebase onto main now that the keystone landed.
